    ...
    */
    ...
    export class Dictionary<K, V>{
        ...
        */
        ...
        pairs():Array<IDictionaryPair<K,V>> {
            let ret:Array<IDictionaryPair<K,V>> = [];
            for (var name in this.table) {
                ret.push(this.table[name]);
            }
            return ret;
        }
         ...
         */
        has(key: K): boolean {
            return !collections.isUndefined(this.get(key));
        }
    ...
    export class MultiDictionary<K, V> {
        ...
        // Since we want to reuse the function name set and types in signature become incompatible 
    ...
    export class Set<T>{
         ...
         */
        contains(element: T): boolean {
            return this.dictionary.has(element);
        }
